...
export function CTASection() {
  return (
    <Section variant="muted" className="pb-24 md:pb-32">
      <Container>
        <motion.div
          variants={fadeUp}
          initial="hidden"
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
            ...
            <p className="text-lg text-white/80 mb-10 max-w-2xl leading-relaxed">
              Whether you need innovative construction, strategic procurement, or integrated logistics, our team is ready to deliver tailored solutions for your organization.
            </p>
